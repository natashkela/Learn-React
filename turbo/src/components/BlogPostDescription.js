  ...
  return (
    <div className="rq-listing-single">
      <div className="rq-listing-standard-image-post">
        ...
        <h3 className="rq-listing-title"><a href="#">{information.title}</a></h3>
        <div className="rq-listing-meta">
          <span className="author-name"><a href="#">{information.author}</a></span>
          <span className="v-line">|</span>
          <span className="date"><a href="#">{information.date}</a></span>
        </div>
        <p className="post-content">
          {information.shortDescription}
        </p>
        <a className="continue-btn rq-btn rq-btn-normal" href="#">Continue <i className="arrow_right"></i></a>
      </div>
    </div>
  );
}
