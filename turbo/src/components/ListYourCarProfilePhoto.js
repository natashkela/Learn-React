    ...
    <div className="list-your-mobile-number margin-bottom-40">
      ...
      <div className="row">
        <div className="col-xs-12 col-sm-12 col-lg-12 col-md-12">
          <div>
            <img src={customerInformation.id && customerInformation.username ? require("../img/users/"+customerInformation.id+"-"+customerInformation.username+".jpg") : require("../img/users/avatar.jpg")} style={{width:"100px",height:"100px", borderRadius:"50%"}} className=" margin-top-15" />
